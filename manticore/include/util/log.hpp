...
/*!
 ...
 @param len
 If this variable is an array, set this to the length of the array, else set
 this to 1

 @param pretty_name
 When dumping the state, if a pretty name is supplied then the pretty name will
 be printed alongside the variable
*/
