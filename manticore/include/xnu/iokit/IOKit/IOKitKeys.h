...
// Property is an array of strings containing CFBundleIdentifiers of service
// being opened
...
#define kIODriverKitHIDFamilyDeviceEntitlementKey                              \
...
// Entitlement required to set properties on the IOResources object as non-root
// user
...
#define kIOMaximumSegmentCountWriteKey                                         \
    "IOMaximumSegmentCountWrite" // (OSNumber)
#define kIOMaximumSegmentByteCountReadKey                                      \
    "IOMaximumSegmentByteCountRead" // (OSNumber)
#define kIOMaximumSegmentByteCountWriteKey                                     \
    "IOMaximumSegmentByteCountWrite" // (OSNumber)
#define kIOMinimumSegmentAlignmentByteCountKey                                 \
    "IOMinimumSegmentAlignmentByteCount" // (OSNumber)
#define kIOMaximumSegmentAddressableBitCountKey                                \
    "IOMaximumSegmentAddressableBitCount" // (OSNumber)
#define kIOMinimumSaturationByteCountKey                                       \
    "IOMinimumSaturationByteCount"                  // (OSNumber)
