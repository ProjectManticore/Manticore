...
#define iokit_vendor_specific_err(return )                                     \
    (sys_iokit | sub_iokit_vendor_specific | return )
...
#define kIOReturnExclusiveAccess                                               \
    iokit_common_err(0x2c5) // exclusive access and
                            //   device already open
#define kIOReturnBadMessageID                                                  \
    iokit_common_err(0x2c6)                            // sent/received messages
...
#define kIOReturnCannotWire                                                    \
    iokit_common_err(0x2de)                          // can't wire down
                                                     //   physical memory
...
#define kIOReturnMessageTooLarge                                               \
    iokit_common_err(0x2e1)                           // oversized msg received
                                                      //   on interrupt port
...
#define kIOReturnDeviceError                                                   \
    iokit_common_err(0x2e9) // the device is not working properly!
#define kIOReturnNoCompletion                                                  \
    iokit_common_err(0x2ea) // a completion routine is required
#define kIOReturnAborted iokit_common_err(0x2eb) // operation aborted
#define kIOReturnNoBandwidth                                                   \
    iokit_common_err(0x2ec) // bus bandwidth would be exceeded
#define kIOReturnNotResponding iokit_common_err(0x2ed) // device not responding
#define kIOReturnIsoTooOld                                                     \
    iokit_common_err(0x2ee) // isochronous I/O request for distant past!
#define kIOReturnIsoTooNew                                                     \
    iokit_common_err(0x2ef) // isochronous I/O request for distant future
